...
public class GirdView3Adapter extends BaseAdapter {
    String TAG="hh";

    private List<ProvinceBean> provinceBeanList;
    private LayoutInflater layoutInflater;

    public GirdView3Adapter(Context context, List<ProvinceBean> provinceBeanList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.girdview3ad, null);
